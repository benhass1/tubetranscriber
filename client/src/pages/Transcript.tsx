...
import TranscriptFallbackCard from "@/components/TranscriptFallbackCard";
...
export default function Transcript() {
  ...
  if (effectiveError || !data) {
    return (
      <TranscriptPageShell>
        <TranscriptFallbackCard
          error={friendlyError || "The transcript service could not retrieve this video."}
          onRetry={retrySameVideo}
          onClear={() => navigate("/")}
        />
      </TranscriptPageShell>
    );
