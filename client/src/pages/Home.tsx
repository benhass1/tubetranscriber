...
const features = [
  { icon: Subtitles, title: "Can I read captions as clean text?", text: "Yes. TubeTranscriber turns available public YouTube captions into a continuous, searchable transcript." },
    ...
    <SiteShell>
      <section className="hero-section">
        ...
        <div className="content-container hero-content">
          ...
          <p className="hero-lede">Paste a YouTube link to read, search, copy, and download its available captions as clear, continuous text — no account required.</p>
      ...
      <section className="seo-explainer content-container" aria-labelledby="generator-heading">
        ...
        <p className="answer-first">TubeTranscriber exports available captions as plain TXT, structured JSON, or timed SRT subtitles, so the same transcript can move from research to editing without reformatting.</p>
